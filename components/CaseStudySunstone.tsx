...
export default function CaseStudySunstone({ onClose, onNext }: { onClose: () => void, onNext?: () => void }) {
          ...
          <div className="relative max-w-4xl mx-auto">
             ...
             <div className="space-y-16 relative">
                {[
                  ...
                  { step: "Visual Stats Panel", desc: "Solidified trust with numerical metrics. Highlighting '40,000 sqft lifestyle club' and '7 acres of low-density living' prominently." },
